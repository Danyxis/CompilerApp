...
namespace CompilerApp
{
    public partial class MainMenuForm : Form // Основная форма приложения
    {
        ...
        public DataGridView GetOutputTable() // Возвращает объект outputTable (таблица вывода)
        {
            return outputTable;
        }

        public DataGridView GetErrorsTable() // Возвращает объект errorsTable (таблица вывода)
        {
            return errorsTable;
        }
